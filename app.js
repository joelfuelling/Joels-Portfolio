...
const dropdownBtn = document.getElementById("dropbutton-id")
const dropdownMenu = document.getElementById("dropmenu")

const dropToggle = function() {
    dropdownMenu.classList.toggle("classon")
...
mySlides[slideIndex].style.display = "inline-block" // FINALLY! Now, it loads with the 1st picture. Obviously this had to be outside the function (thank you Angel for the nudges!)
